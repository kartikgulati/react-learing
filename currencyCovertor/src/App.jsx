...
function App() {
  ...
  return (
    ...
    <div
      className="w-full h-screen flex flex-wrap justify-center items-center bg-cover bg-no-repeat bg-opacity-60"
      style={{
    ...
    >
      ...
      <div className="text-center text-5xl mb-5 font-bold drop-shadow-[0_5px_1.8px_rgba(75,75,75,100)] outline-white text-white " >
        <h1>Currency Convertors</h1>
      </div>
